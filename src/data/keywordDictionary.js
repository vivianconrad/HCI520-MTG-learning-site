...
export const KEYWORD_TERMS = [
  ...
  },
  {
    ...
    definition:
      'Cancel a spell on the stack so it has no effect and goes to the graveyard. Counterspell is a common example. You cast the counter instant while the other spell is still waiting to resolve.',
  },
  {
    term: 'Generic mana',
    definition:
