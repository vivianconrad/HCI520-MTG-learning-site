...
const TURN_STEPS = [
  ...
  },
  {
    ...
    body: 'After combat, you get another main phase. If you have not played a land yet this turn, you may play it now, but you still get only one land total per turn. You can cast more sorcery-speed spells when the stack is empty.',
  },
  {
    id: 'end',
    label: 'End',
...
export default function FirstGame({ session }) {
  ...
  return (
    <PageLayout
      title="Starting a Game · Learn to Play MTG"
    ...
    >
      <div className="first-game__frame page-layout__content-frame">
        ...
        <p className="first-game__hint">Open all six steps before you continue to Lesson 1.</p>
