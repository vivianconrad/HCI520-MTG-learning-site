...
- Name: viewport smoke >> interactive lessons load and fit the viewport width
- Location: C:\Users\ConradV\source\repos\HCI520-MTG-learning-site\e2e\viewport-smoke.spec.cjs:17:3
...
Locator: getByRole('heading', { name: /how to read a card/i })
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByRole('heading', { name: /how to read a card/i })

    at C:\Users\ConradV\source\repos\HCI520-MTG-learning-site\e2e\viewport-smoke.spec.cjs:22:72
```
