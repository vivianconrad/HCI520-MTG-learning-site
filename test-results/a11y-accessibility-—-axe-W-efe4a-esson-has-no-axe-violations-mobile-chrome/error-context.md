...
- Name: accessibility — axe WCAG scans >> card anatomy lesson has no axe violations
- Location: C:\Users\ConradV\source\repos\HCI520-MTG-learning-site\e2e\a11y.spec.cjs:16:5
...
Call log:
  - navigating to "http://127.0.0.1:4173/HCI520-MTG-learning-site/lesson/1", waiting until "load"
    ...
    at gotoCheckedPage (C:\Users\ConradV\source\repos\HCI520-MTG-learning-site\e2e\a11y.spec.cjs:8:14)
    at C:\Users\ConradV\source\repos\HCI520-MTG-learning-site\e2e\a11y.spec.cjs:17:7
```
...
```ts
   ...
   4 | const { seedSession } = require('./helpers/session.cjs')
   5 |
...
>  8 |   await page.goto(pageCheck.path)
  ...
  53 |       name: /explore all six numbered markers on the card before continuing/i,
  54 |     })
  55 |     await expect(gateHint).toBeVisible()
  56 |     await gateHint.click()
  57 |     await expect(page.locator('.card-anatomy__marker--missing').first()).toBeVisible()
  58 |   })
  59 |
